...
BenScene::BenScene() : Scene(), angle(0.0f), direction(1.0f)
{
	...
	go1 = new GameObject(ShapeTypes::SphereShape, Colour(0.4, 0.7, 0.7));
	...
	go2 = new GameObject(ShapeTypes::SphereShape, Colour(0.7, 0.4, 0.7));
	go2->AddComponent<Rigidbody>();
	go2->GetComponent<Rigidbody>()->SetPosition(Vector4(1.0f, 7.0f, 0.0f, 1.0f));
