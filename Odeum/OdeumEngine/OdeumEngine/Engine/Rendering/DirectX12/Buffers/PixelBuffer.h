...
// defines a buffer that represents a collection of pixels (width * height, possible depth). Useful functions for finding appropriate dxgi format (bits/bytes per pixel and type)
